...
# Используем ENTRYPOINT для основного исполняемого файла,
# а CMD — для аргументов по умолчанию
ENTRYPOINT ["/app/game_server", "--config-file", "/app/data/config.json", "--www-root", "/app/static", "--randomize-spawn-points", "1"]
# "--tick-period", "100"